...
## 🔧 Arhitektura
Sistem je zgrajen v treh ključnih plasteh:

### 1️⃣ Senti OS (operacijska plast)
- varnostni protokoli
- projektna pravila
- AI razvojni standardi
- definicije modulov in integracij
...
## 🚀 Namen
Primarni cilj sistema je:
- Avtomatska korekcija kode
- Avtomatska analiza projekta
- Varnostno preverjanje AI generirane kode
